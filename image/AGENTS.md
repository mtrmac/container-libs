...
Have some (but not slavish) dereference to existing code structure: don't
...
decisions, non-obvious constraints that require use one approach over another, or _sometimes_
